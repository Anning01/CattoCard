          ...
          <div class="flex items-center gap-3">
            ...
            <div class="hidden sm:flex items-center relative">
              <input
                ...
                type="text"
                placeholder="搜索商品..."
                class="w-48 lg:w-64 pl-10 pr-4 py-2 text-sm bg-gray-100 border-0 rounded-full focus:ring-2 focus:ring-primary-500/20 focus:bg-white transition-all"
        ...
        <div class="p-4">
          ...
          <div class="relative mb-4">
            <input
              ...
              type="text"
              placeholder="搜索商品..."
              class="w-full pl-10 pr-4 py-2.5 text-sm bg-gray-100 border-0 rounded-xl focus:ring-2 focus:ring-primary-500/20"
              @keyup.enter="handleSearch"
            />
